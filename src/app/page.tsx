...
function About() {
  return (
    <div className="flex flex-col gap-4 text-slate-300">
      <p>
        Software Developer @ Dayforce, Computer Science @ University of Guelph.
        Interested in distributed systems, cloud computing, and developer
        experience.
      </p>

      <p>
        I also keep a log and personal reference notes on what I'm reading{" "}
        <Link
